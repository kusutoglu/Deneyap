...
{ 
 ...
 myservo2.attach(SERVOPIN2); //Eğer <ESP32Servo.h> kütüphanesi kullanırsanız, bu ve aşağıdaki 2 satırda parantez içerisindeki 2’inci parametreyi silin, tek parametre yeterlidir. 
